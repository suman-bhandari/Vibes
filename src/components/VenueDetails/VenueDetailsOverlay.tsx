...
interface VenueDetailsOverlayProps {
  venue: Venue | null;
  isOpen: boolean;
  onClose: () => void;
}

const VenueDetailsOverlay: React.FC<VenueDetailsOverlayProps> = ({ venue, isOpen, onClose }) => {
  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 pointer-events-none">
        <div
          className="bg-white dark:bg-gray-800 rounded-xl shadow-2xl w-full max-w-2xl max-h-[85vh] flex flex-col pointer-events-auto overflow-hidden"
        ...
        >
          ...
          <div className="flex-shrink-0 border-t border-gray-200 dark:border-gray-700 px-6 py-4 bg-white dark:bg-gray-800">
